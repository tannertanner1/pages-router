  ...
  return (
    ...
    <>
      ...
      <div className="relative overflow-hidden bg-clip-border shadow-md">
        ...
        {/* <div className="absolute inset-0 flex flex-col justify-center items-center h-3/4"> */}
        <div className="absolute inset-0 flex flex-col justify-center items-center h-5/6">
          <div className="whitespace-break-spaces pl-2 md:-pl-2 flex flex-col md:flex-row text-center md:gap-y-3 leading-tight md:leading-normal text-6xl md:text-7xl font-bold bg-gradient-to-r from-orange-700 via-blue-500 to-green-400 text-transparent bg-clip-text bg-300% animate-gradient">
            <span>Learn. </span>
            <span>Music. </span>
            <span>Online. </span>
          </div>
          ...
          <div className="flex gap-x-8 mt-10 justify-center items-center">
            <Link href="/about" className="items-center justify-center drop-shadow-lg">
              <button className="inline-flex text-invert text-base font-medium hover:font-semibold border-0 text-opacity-90 hover:text-opacity-100 dark:text-opacity-90 dark:hover:text-opacity-100 bg-opacity-90 hover:bg-opacity-100 dark:bg-opacity-90 dark:hover:bg-opacity-100 transition hover:-translate-y-1 hover:scale-110 duration-300">
                <span className="relative rounded-md px-5 py-2.5 transition-all ease-in bg-invert">Learn More</span>
              </button>
      ...
      <div className="text bg text-center pt-8">
