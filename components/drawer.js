      ...
      <drawer className="drawer flex flex-col justify-center top-0 mb-2 p-4">        
        ...
        <div className="flex flex-col items-center">
          <button className={`menu-btn text-lg flex flex-row mt-4 mr-0.5 ${isAccordion ? 'clicked' : ''}`} onClick={() => handleAccordion("about")}>
            <svg className="mt-1 mr-1 w-4 h-4" stroke="currentColor" strokeWidth="2.5" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="link text-neutral-400 dark:text-neutral-500 ml-0.5 mt-6 text-lg" onClick={handleDrawer}>
